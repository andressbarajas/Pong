...
namespace PongaThemes
{
    ...
    class LevelSelectorScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            m_grid = new GridMenu(HelperUtils.SafeBoundary.X + 66, HelperUtils.SafeBoundary.Y + 40, 4, m_pln_txt, m_soundBank);
            m_grid.Spacing = 30;
            m_grid.SelectedTint = Color.Blue;
            m_grid.AddItem(m_pong, new Selected(PongSelected), "pong");
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Begin();
            spriteBatch.Draw(m_pln_txt, HelperUtils.BuildRect(new Rectangle(HelperUtils.SafeBoundary.X, HelperUtils.SafeBoundary.Y, 1024, 612), -0.03f), new Color(0, 0, 0, 128));
